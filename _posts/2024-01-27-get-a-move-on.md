...
![Screenshot of icon being moved between desktops]({{ site.baseURL }}/assets/img/blog/2024-01-27_moveicon.gif "Screenshot of icon being moved between desktops"){:class="img-responsive"}
