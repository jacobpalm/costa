...
![Screenshot of unnamed shell version BETA 3]({{ site.baseURL }}/assets/img/blog/2024-02-01-shell.png "Screenshot of unnamed shell version BETA 3"){:class="img-responsive"}
...
![Screenshot of JEM Systems 3.0]({{ site.baseURL }}/assets/img/blog/2024-02-01-jemsys.png "Screenshot of JEM Systems 3.0"){:class="img-responsive"}
...
The result was Costa [0.9.8]({{ site.baseURL }}/archive.html#version098) from the end of 2009. It featured a complete desktop, a bunch of accessories such as the new icon editor, and an overall consistent and clean interface. I had intentions of releasing version 1.0.0 that same year, but life has a way of getting in the way of plans. Version [0.9.9]({{ site.baseURL }}/archive.html#version099) wouldn't be released until 2011, followed at long last by version [1.0.0]({{ site.baseURL }}/archive.html#version094) in May of 2012. **After 8 years, the first full release of Costa was out!**

![Screenshot of Costa 1.0.0]({{ site.baseURL }}/assets/img/blog/2024-02-01-costa-100.png "Screenshot of Costa 1.0.0"){:class="img-responsive"}
...
![Screenshot of Costa 1.7.5]({{ site.baseURL }}/assets/img/blog/2024-02-01-costa-175.png "Screenshot of Costa 1.7.5"){:class="img-responsive"}
