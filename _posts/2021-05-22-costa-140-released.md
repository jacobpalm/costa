...
---
While it may not look like much has changed, there's quite a few changes behind the scenes in this new version.
...
Full details about this and previous releases are available in the [archive]({{ site.baseURL }}/archive.html#version140).